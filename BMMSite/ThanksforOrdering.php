...
if(isset($_POST["submit"])){
		$CLOclname = $_POST['clientNameTxt'];
		$CLOProName = $_POST['ProNameTxt'];
		$CLOPrprice = $_POST['PropriceTxt'];
		$CLOQuantity = $_POST['quantityTxt'];
		$CLODiscount = $_POST['Discount'];
		$CLODisAmt = $_POST['DisAmtTXt'];
		$CLOAmount = $_POST['AmountTxt'];
		$CLOshipAmt = $_POST['shippingTxt'];
		$CLOAddress = $_POST['AddressTxt'];
		$CLOCity = $_POST['CityTxt'];
		$CLOZipCode = $_POST['ZipCodeTxt'];
		$CLOTel = $_POST['TelNoTxt'];
		$CLOGrandTot = $_POST['GrandTxt'];
		$dataTime = date("Y-m-d");
		
		$CLOAdminName = $_POST['AdminNameTxt'];	
		$CLOCusId = $_POST['customeridTXt'];
		$CLOprId = $_POST['ProidTxt'];
		$CLOImgUrl = $_POST['ImgustTxt'];
		
		
		$insert = $link->query("INSERT into orders (orderDate,clientNo,ClientName,productId,ProductName,Price,Discount,Amount,DisAmt,ShippingCharge,AdminId,OrderState,image,quantity,GrandTot) VALUES ('$dataTime','$CLOCusId','$CLOclname','$CLOprId','$CLOProName','$CLOPrprice','$CLODiscount','$CLOAmount','$CLODisAmt','$CLOshipAmt','$CLOAdminName','Pending','$CLOImgUrl','$CLOQuantity','$CLOGrandTot')");
		
		$insertb = $link->query("INSERT into shippingdetails (CName,address,City,zipcode,TelNo,AdminName,CustomerId) VALUES ('$CLOclname','$CLOAddress','$CLOCity','$CLOZipCode','$CLOTel','$CLOAdminName','$CLOCusId')");
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="product-images">
                                     <p> </p><h2>Thanks For your Order</h2>
