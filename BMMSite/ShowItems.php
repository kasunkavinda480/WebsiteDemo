...
?>
	...
	<div id="MainDiv">
		...
		<input type="text" name="SeachTxt" placeholder="Seach..." >
		<label for="CategrieLbl">Categrie :</label>
		<?php
...
<?php
	...
	$result_count = mysqli_query($link,"SELECT COUNT(*) As total_records FROM product WHERE PName Like '%".$Seach."%' AND Pcategrie like '%".$category."%' ");
	...
	$result = mysqli_query($link,"SELECT * FROM product WHERE PName like '%".$Seach."%' AND Pcategrie like '%".$category."%' LIMIT $offset, $total_records_per_page");
	$no = '0';
