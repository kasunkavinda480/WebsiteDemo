...
if(isset($_POST["submit"])){
	...
	$update = $link->query("update orders set quantity='".$CLOQuantity."',DisAmt='".$CLODisAmt."',Amount='".$CLOAmount."',GrandTot='".$CLOGrandTot."' where orderId='".$COLID."'");
}
?>
 ...
 <?php } mysqli_close($link);?>
                    ...
                    <div class="product-content-right">
                        <div class="woocommerce">
							...
							<form action="Manage.php" method="post" enctype="multipart/form-data" action="ThanksforSpecialOrdering.php" class="checkout" name="checkout">
                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
											...
											<p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                                ...
                                                <input type="text" name="quantityTxt" value="<?php echo "$quantity"; ?>" onchange="calculateAmount(this.value)" required placeholder="" id="billing_first_name"  class="input-text ">
                                            </p>
											...
											<p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                                ...
                                                <input type="text" name="DisAmtTXt" value="<?php echo "$Disamt"; ?>" id="disamtTxt" readonly placeholder="" id="billing_first_name" class="input-text ">
                                            </p>
											
											<p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                                <label class="" for="billing_first_name">Amount <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" name="AmountTxt"value="<?php echo "$amount"; ?>" id="tot_amount" readonly placeholder="" id="billing_first_name" class="input-text ">
                                            </p>
		...
		<input type="hidden" name="ImgustTxt" value="<?php echo "$imageURL"; ?>">
									...
									<p id="billing_first_name_field" class="form-row form-row-first validate-required">
											...
											<p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                                ...
                                                <input type="text" name="GrandTxt" value="<?php echo "$grandTot"; ?>" id="grandTXt" readonly placeholder="" id="billing_first_name" class="input-text ">
                                            </p>
	...
	<script>
            function calculateAmount(val) {
				...
				let GrandTotal = tot_price + shipchage;
