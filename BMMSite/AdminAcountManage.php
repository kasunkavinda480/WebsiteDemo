...
<?php
	...
	$result_count = mysqli_query($link,"SELECT COUNT(*) As total_records FROM profitmanage WHERE AdminName Like '%".$AdminName."%'");
	...
	$result = mysqli_query($link,"SELECT * FROM profitmanage WHERE AdminName like '%".$AdminName."%'  LIMIT $offset, $total_records_per_page");
	$no = '0';
...
?>
	...
	<td id="itmeNameCol" ><?php  echo $CusName ?></td>
	...
	<td><?php echo "".$row['AdminProfit']."" ?></td>
