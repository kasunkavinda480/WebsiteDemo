...
require_once 'config.php';
	...
	if(isset($_POST["submit"])){
		$username = $_POST['clientNameTxt'];
		$Con = 'Active';
		$active = $_POST['ActivateCode'];
		$update = $link->query("update customerregistor set ConEmail='".$Con."' where username='".$active."'");
...
<div id="navslide">
	...
	<div id="margin">
		...
		<form action="ActivateAcount.php" method="post" enctype="multipart/form-data">
		
			<input type="hidden" name="clientNameTxt">
			<h3>Answer the question to activate your acount.....</h3>
			<h1>What is your user Name type for this site...?</h1>
			<label>Answer :</label><input type="text" name="ActivateCode">
