<?php 
	...
	function login(){
		...
		if (count($errors) == 0) {
			...
			$query = "SELECT * FROM adminusers WHERE username='$username' AND password='$password' LIMIT 1";
			...
			if (mysqli_num_rows($results) == 1) { // user found
				...
				if ($logged_in_user['user_type'] == 'admin') {
					...
					$_SESSION['success']  = "";
					header('location: CustomerOrderManagemant.php');		  
				}else{
					$_SESSION['user'] = $logged_in_user;
					$_SESSION['success']  = "";
